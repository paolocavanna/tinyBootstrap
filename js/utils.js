...
(function(app, d){
	...
	app.docCookies = {
		...
		setItem: function(sKey, sValue, vEnd, sPath, sDomain, bSecure) {
			...
			cookie = encodeURIComponent(sKey) + "=" + encodeURIComponent(sValue) + sExpires + (sDomain ? "; domain=" + sDomain : "") + (sPath ? "; path=" + sPath : "") + (bSecure ? "; secure" : "");
		...
		removeItem: function(sKey, sPath, sDomain) {
			...
			cookie = encodeURIComponent(sKey) + "=; expires=Thu, 01 Jan 1970 00:00:00 GMT" + (sDomain ? "; domain=" + sDomain : "") + (sPath ? "; path=" + sPath : "");
